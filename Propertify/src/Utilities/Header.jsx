    ...
    return (
        <nav>
            <ul className="Navbar" id="otis">
                ...
                <li><button className="button"><a href="/LoginPage" className="internal-text"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
